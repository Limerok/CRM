                            ...
                            >
                                ...
                                <td>
                                    <div class="input-group input-group-sm mb-1">
                                        <input type="number" step="0.01" min="0" class="form-control text-end payment-value-input" value="<?= $paymentValue; ?>" placeholder="0.00">
                                ...
                                <td>
                                    <div class="input-group input-group-sm mb-1">
                                        <input type="number" step="0.01" min="0" class="form-control text-end logistics-value-input" value="<?= $logisticsValue; ?>" placeholder="0.00">
                                ...
                                <td>
                                    <div class="input-group input-group-sm mb-1">
                                        <input type="number" step="0.01" min="0" class="form-control text-end reviews-value-input" value="<?= $reviewsValue; ?>" placeholder="0.00">
